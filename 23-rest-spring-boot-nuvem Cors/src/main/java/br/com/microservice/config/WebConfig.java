...
public class WebConfig implements WebMvcConfigurer{
	...
	/*
	 * Outra forma de habiltar o Corss na aplicalção.
	 */
	
	public void addCorsMappings(CorsRegistry registry) {
		registry.addMapping("/**")
			.allowedMethods("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS", "HEADS", "TRACE", "CONNECT");// aqui premiti cross dominino para todos, SOMENTE PARA ESSES VERBOS(GET/POST/DELETE)
	}
