...
public class PersonController {
	...
	//Aqui injeção de dependencia
		...
		// SOMA
		//@CrossOrigin(origins = "http://localhost:8080")//dominios especifícos
		...
		//@CrossOrigin(origins = {"http://localhost:8080", "https://www.motox.com.br"})//para 2 dominios especifícos
